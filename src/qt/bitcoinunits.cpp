...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("IW");
    case mBTC: return QString("mIW");
    case uBTC: return QString::fromUtf8("μIW");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("iWalletCoins"));
    case mBTC: return QString(QObject::tr("Milli-iWalletCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-iWalletCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}

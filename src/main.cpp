...
unsigned int nStakeMinAge = 2 * 24 * nOneHour; //
unsigned int nStakeMaxAge = 30 * 24 * nOneHour; // 
...
const string strMessageMagic = "iWalletCoin Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("iWalletCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in iWalletCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // iWalletCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "iWalletCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "IW Genesis";
        CTransaction txNew;
        txNew.nTime = 1470105017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1470105017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3038487; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb7, 0xf8, 0xe2, 0xe5 };
